...
public class EmailService {
    ...
    public void sendWelcome(String toEmail, String fullName, String username) {
        try {
            ...
            System.err.println(">>> [EMAIL ERROR] Failed to send welcome email to " + toEmail + ": " + e.getMessage());
        }
    }
    ...
    public void sendPasswordResetSuccess(String toEmail, String fullName, String username) {
        try {
            ...
            System.err.println(">>> [EMAIL ERROR] Failed to send password reset success email to " + toEmail + ": " + e.getMessage());
        }
    }
    ...
    public void sendProfileUpdateOtp(String toEmail, String otp) {
        try {
            ...
            System.err.println(">>> [EMAIL ERROR] Failed to send profile update OTP to " + toEmail + ": " + e.getMessage());
