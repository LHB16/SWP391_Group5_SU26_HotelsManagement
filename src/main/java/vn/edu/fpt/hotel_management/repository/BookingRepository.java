...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
        ...
        List<Booking> findByHotelIdInAndCheckOutDateOrderByCreatedAtDesc(List<Integer> hotelIds,
                        LocalDate checkOutDate);
        ...
        /**
         * Lấy danh sách booking cần đối soát CÓ tìm kiếm theo tên khách sạn HOẶC tên
         * Owner.
         * Điều kiện giống phương thức trên nhưng thêm bộ lọc OR cho hotel.name và
