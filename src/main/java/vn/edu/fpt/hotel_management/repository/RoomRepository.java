...
/**
 * Repository cung cấp các phương thức truy vấn dữ liệu cho bảng rooms.
 */
@Repository
public interface RoomRepository extends JpaRepository<Room, Integer> {
     ...
     */
    @Query("SELECT DISTINCT r.type FROM Room r WHERE r.hotelId = :hotelId ORDER BY r.type ASC")
